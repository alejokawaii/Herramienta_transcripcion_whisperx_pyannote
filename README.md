...
8. Por si acaso la herramienta FFmpeg (que lee y reconoce los archivos de audio) no se abre bien, instala en el entorno esta librería. Introduce en la terminal el siguiente comando: conda install -c conda-forge ffmpeg -y.
Si tampoco funciona la página en la web (Error Windows 32: No se encuentra el archivo...), entra en la carpeta "Transcriptor Local", busca la subcarpeta llamada "ffmpeg-2026-02-18-git-52b676bb29-full_build" y entra después en la subcarpeta "bin".
